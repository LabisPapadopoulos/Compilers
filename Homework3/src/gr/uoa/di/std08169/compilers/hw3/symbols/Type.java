...
import gr.uoa.di.std08169.compilers.hw3.syntaxtree.ArrayType;
import gr.uoa.di.std08169.compilers.hw3.syntaxtree.BooleanType;
import gr.uoa.di.std08169.compilers.hw3.syntaxtree.Identifier;
import gr.uoa.di.std08169.compilers.hw3.syntaxtree.IntegerType;
...
public class Type {
    ...
    public Type(gr.uoa.di.std08169.compilers.hw3.syntaxtree.Type type) {
